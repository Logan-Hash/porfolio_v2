<section class="services-area page-section" id='service'>
    <div class="container">
        <div class="row">
            <div class="col-lg-12 text-center services-title">
                <h1 class="text-uppercase title-text" id="cursor" data-aos="zoom-in-down">Services Offers</h1>
                <p class="para">
        ...
        <div class="container services-list">
            <div class="row">
                <div class="col-lg-3 col-md-6 col-sm-12" data-aos="zoom-in-right" data-aos-duration="2000">
                    <div class="services">
                ...
                <div class="col-lg-3 col-md-6 col-sm-12" data-aos="zoom-out" data-aos-duration="2000">
                    <div class="services">
                        <div class="sevices-img text-center py-4">
                ...
                <div class="col-lg-3 col-md-6 col-sm-12" data-aos="zoom-in-left" data-aos-duration="2000">
                    <div class="services">
                        <div class="sevices-img text-center py-4">
